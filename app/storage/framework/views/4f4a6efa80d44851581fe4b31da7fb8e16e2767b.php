                                ...
                                <table class="centered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <input value="<?php echo e($detalles->comentarios); ?>" id="comentario" type="text" class="form-control" name="comentario<?php echo e($detalles->id); ?>">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.js"></script>
   ...
   <script type="text/javascript">
       ...
       $(".cambiar").on('change', function postinput(event){
        ...
        $.ajax({
          url: "<?php echo e(route('pedidos.crearSession')); ?>",
          type:"POST",
          data:{
